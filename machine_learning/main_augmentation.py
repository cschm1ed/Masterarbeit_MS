...
# ----
# MAIN: ERZEUGEN VON SYNTHETISCHEN DATEN
# ----
...
data1 = pd.read_parquet(
    r'C:\Users\maxi1\Documents\UNI MASTER KIT\#MASTERARBEIT\05 Sonstige Dokumente\PycharmProjects\Masterarbeit_Schubert\raw_data_sorted\#machine_learning\Trainingsdaten\output_aug_new2_18600.parquet')
data2 = pd.read_parquet(
    r'C:\Users\maxi1\Documents\UNI MASTER KIT\#MASTERARBEIT\05 Sonstige Dokumente\PycharmProjects\Masterarbeit_Schubert\raw_data_sorted\#machine_learning\Trainingsdaten\output_raw+aug+aug_new_18600.parquet')
