# ----
# FUNKTIONEN ZUR STEUERUNG VON LOGIC 2 (API)
# ----
...
def recordLogic2Data(dauer, motor, getriebe):
    ...
    with automation.Manager.connect(port=10430) as manager:
        device_configuration = automation.LogicDeviceConfiguration(
            enabled_digital_channels=[0, 1, 4, 5], # evtl. noch Channel 2 als Trigger (siehe auch unten) & Channel 6 als Z bei Glasmaßstab
